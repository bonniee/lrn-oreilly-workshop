...
let ensureBuildConstantsExistsIOSAsync = (() => {
  var _ref12 = _asyncToGenerator(function* (configFilePath) {
    ...
    if (!doesBuildConstantsExist) {
      yield (0, (_ExponentTools || _load_ExponentTools()).createBlankIOSPropertyListAsync)(configFilePath, 'EXBuildConstants');
      console.log('Created `EXBuildConstants.plist` because it did not exist yet');
    }
    return;
  });

  return function ensureBuildConstantsExistsIOSAsync(_x30) {
...
let prepareDetachedBuildAsync = exports.prepareDetachedBuildAsync = (() => {
  var _ref13 = _asyncToGenerator(function* (projectDir, args) {
    ...
    if (args.platform === 'ios') {
      ...
      if (!args.skipXcodeConfig) {
        ...
        yield ensureBuildConstantsExistsIOSAsync(configFilePath);
        yield (0, (_ExponentTools || _load_ExponentTools()).modifyIOSPropertyListAsync)(configFilePath, 'EXBuildConstants', function (constantsConfig) {
  ...
  return function prepareDetachedBuildAsync(_x31, _x32) {
