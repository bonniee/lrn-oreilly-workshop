...
let configureIOSIconsAsync = (() => {
  var _ref9 = _asyncToGenerator(function* (manifest, destinationIconPath, projectRoot) {
    if (process.platform !== 'darwin') {
      console.warn('`sips` utility may or may not work outside of macOS');
    }
    ...
    iconSizes.forEach(function (iconSize) {
      ...
      iconResolutions.forEach((() => {
        var _ref10 = _asyncToGenerator(function* (iconResolution) {
  ...
  return function configureIOSIconsAsync(_x14, _x15, _x16) {
