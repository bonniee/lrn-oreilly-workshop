...
let _validateReactNativeVersionAsync = (() => {
  ...
  return function _validateReactNativeVersionAsync(_x11, _x12, _x13, _x14, _x15) {
...
let _validateNodeModulesAsync = (() => {
  ...
  return function _validateNodeModulesAsync(_x16) {
...
let validateLowLatencyAsync = exports.validateLowLatencyAsync = (() => {
  ...
  return function validateLowLatencyAsync(_x17) {
...
let validateWithNetworkAsync = exports.validateWithNetworkAsync = (() => {
  ...
  return function validateWithNetworkAsync(_x18) {
...
let validateAsync = (() => {
  ...
  return function validateAsync(_x19, _x20) {
...
let getExpoSdkStatus = exports.getExpoSdkStatus = (() => {
  ...
  return function getExpoSdkStatus(_x21) {
